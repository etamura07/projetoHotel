...
import fatec.hotel.TableModels.ReservaTableModel;
 ...
 * @author memet
 */
public class ReservaListaJFrame extends javax.swing.JFrame {
    ReservaTableModel modelo = new ReservaTableModel();
    
    /**
     * Creates new form ReservaListaJFrame
     */
    public ReservaListaJFrame() {
        initComponents();
        carregarLista();
    }
    ...
    private void carregarLista(){
        ...
        List<Reserva> lista = dao.consultar("");
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ReservaInserirJFrame frame = new ReservaInserirJFrame();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReservaListaJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservaListaJFrame().setVisible(true);
            }
        });
    }
